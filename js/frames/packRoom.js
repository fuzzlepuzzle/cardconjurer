...
var masks = [{src:'/img/frames/m15/room/maskRight.png', name:'Right Half'}, {src:'/img/frames/m15/split/maskTopRight.png', name:'Top Right'}, {src:'/img/frames/m15/split/maskBottomLeft.png', name:'Bottom Left'}];
