...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//text
	loadTextOptions({
		name: {name:'Name', text:'', x:172/2010, y:1500/2814, width:1667/2010, height:153/2814, font:'Eveleth', size:0.0381, align:'left'},
		rules: {name:'Rules Text', text:'', x:0.086, y:1316/2100, width:0.828, height:0.2875, font:'Overpass', size:0.0362},
		domaintype: {name:'Domain Type', text:'', x:0.0854, y:1193/2100, width:0.8292, height:0.0543, oneLine:true, font:'Eveleth Regular', size:0.0324},
		cardtype: {name:'Card Type', text:'', x:1480/2010, y:1443/2814, width:2010/2010, height:200/2814, oneLine:true, font:'Overpass', size:0.01},
		level: {name:'Level', text:'', y:126/2100, width:1390/1500, height:71/2100, oneLine:true, font:'Eveleth Clean', size:71/1638, align:'right'},
