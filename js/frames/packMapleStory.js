...
availableFrames = [
	{name:'White Frame', src:'/img/frames/custom/mapleStory/w.png', masks:masks},
...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//sets card version
	card.version = 'mapleStory';
	//makes pixel mana symbol work
	...
	//text
	loadTextOptions({
		mana: {name:'Mana Cost', text:'', y:0.0613, width:0.9292, height:71/2100, oneLine:true, size:71/1638, align:'right', manaCost:true, manaSpacing:0, manaPrefix:'pixel'},
		title: {name:'Title', text:'', x:0.0854, y:0.0522, width:0.8292, height:0.0543, oneLine:true, font:'MalpeStoryFont', size:0.0341, outlineWidth:0.008, color:'#d8b247'},
		type: {name:'Type', text:'', x:0.0854, y:0.5664, width:0.8292, height:0.0543, oneLine:true, font:'MalpeStoryFont', size:0.0284, outlineWidth:0.008, color:'#d8b247'},
		rules: {name:'Rules Text', text:'', x:0.086, y:0.6303, width:0.828, height:0.2875, size:0.033, font:'MalpeStoryFont', outlineWidth:0.008, color:'white'},
		pt: {name:'Power/Toughness', text:'', x:0.7928, y:0.902, width:0.1367, height:0.0372, size:0.0372, font:'MalpeStoryFont', oneLine:true, align:'center', color:'white'}
	});
}
