...
var masks = [{src:'/img/frames/m15/regular/m15MaskPinlineTall.png', name:'Pinline'}, {src:'/img/frames/m15/regular/m15MaskTitle.png', name:'Title'}, {src:'/img/frames/m15/regular/m15MaskType.png', name:'Type'}, {src:'/img/frames/m15/regular/m15MaskRulesTall.png', name:'Rules'}, {src:'/img/frames/m15/regular/m15MaskFrameTall.png', name:'Frame'}, {src:'/img/frames/m15/regular/m15MaskBorder.png', name:'Border'}];
var bounds = {x:0.7573, y:0.8848, width:0.188, height:0.0733};
var bounds2 = {x:0.4254, y:0.9005, width:0.1494, height:0.0486};
//defines available frames
availableFrames = [
	{name:'White Frame', src:'/img/frames/m15/ub/tall/w.png', masks:masks},
	{name:'Blue Frame', src:'/img/frames/m15/ub/tall/u.png', masks:masks},
	{name:'Black Frame', src:'/img/frames/m15/ub/tall/b.png', masks:masks},
	{name:'Red Frame', src:'/img/frames/m15/ub/tall/r.png', masks:masks},
	{name:'Green Frame', src:'/img/frames/m15/ub/tall/g.png', masks:masks},
	{name:'Multicolored Frame', src:'/img/frames/m15/ub/tall/m.png', masks:masks},
	{name:'Artifact Frame', src:'/img/frames/m15/ub/tall/a.png', masks:masks},
	{name:'Land Frame', src:'/img/frames/m15/ub/tall/l.png', masks:masks},
	{name:'Vehicle Frame', src:'/img/frames/m15/ub/tall/v.png', masks:masks},
	{name:'White Land Frame', src:'/img/frames/m15/ub/tall/wl.png', masks:masks},
	{name:'Blue Land Frame', src:'/img/frames/m15/ub/tall/ul.png', masks:masks},
	{name:'Black Land Frame', src:'/img/frames/m15/ub/tall/bl.png', masks:masks},
	{name:'Red Land Frame', src:'/img/frames/m15/ub/tall/rl.png', masks:masks},
	{name:'Green Land Frame', src:'/img/frames/m15/ub/tall/gl.png', masks:masks},
	{name:'Multicolored Land Frame', src:'/img/frames/m15/ub/tall/ml.png', masks:masks},
