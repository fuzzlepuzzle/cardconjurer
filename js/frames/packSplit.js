...
var masks = [{src:'/img/frames/m15/split/top.svg', name:'Top Half'}, {src:'/img/frames/m15/split/bottom.svg', name:'Bottom Half'}, {src:'/img/frames/m15/split/maskTopRight.png', name:'Top Right'}, {src:'/img/frames/m15/split/maskBottomLeft.png', name:'Bottom Left'}];
